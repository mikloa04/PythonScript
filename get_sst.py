#Script để tải truyện từ https://sstruyen.vn
...
strURLStory='https://sstruyen.vn/dam-ma/chuong-'
StartChapter=1 #So chuong bat dau
EndChapter=2 #So chuong ket thuc 
filenameTXT ="dam-ma-239.txt"
filelog ="log.txt"
...
while (x<= EndChapter):
    ...
    with open(filenameHTML, encoding="utf-8") as fp:
        ...
        try:
            ...
            #Lay noi dung chuong
            _text = ''
            for _div in soup.find_all("div", class_="content_wrap1"):
            #Loai bo tag p
                for elem in _div.find_all("br"):
